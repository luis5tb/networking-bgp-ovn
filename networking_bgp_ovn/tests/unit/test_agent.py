...
from networking_bgp_ovn import agent
...
class TestAgent(test_base.TestCase):
    ...
    @mock.patch('networking_bgp_ovn.config.init')
    @mock.patch('networking_bgp_ovn.config.setup_logging')
    @mock.patch('networking_bgp_ovn.agent.BGPAgent')
